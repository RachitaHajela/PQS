...
public class AddressBook {
  ...
  /*
   * changed the below function's return type from void to boolean for making the catch block reachable in Unit tests.
   */
  /**
   ...
   * @param addressBook
   */
  public boolean saveToFile(String path, AddressBook addressBook) {
    try {
